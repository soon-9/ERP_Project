		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[RS] 렌탈회수검수",
									"targetURL": "#zc303rscheckzc303rscheck-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zc303rscheckzc303rscheck-display": {
								"semanticObject": "zc303rscheckzc303rscheck",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zc303.rs.check.zc303rscheck",
									"url": sap.ui.require.toUrl("zc303/rs/check/zc303rscheck")
								}
							}
						}
					}
