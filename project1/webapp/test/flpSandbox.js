		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#sdfdsfdsproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sdfdsfdsproject1-display": {
								"semanticObject": "sdfdsfdsproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sdfdsfds.project1",
									"url": sap.ui.require.toUrl("sdfdsfds/project1")
								}
							}
						}
					}
