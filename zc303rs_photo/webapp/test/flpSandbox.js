		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[RS] 태블릿 사진 업로드",
									"targetURL": "#zc303rsphotozc303rsphoto-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zc303rsphotozc303rsphoto-display": {
								"semanticObject": "zc303rsphotozc303rsphoto",
								"action": "display",
								"description": "[RS] 태블릿 사진 업로드",
								"title": "[RS] 태블릿 사진 업로드",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zc303.rs.photo.zc303rsphoto",
									"url": sap.ui.require.toUrl("zc303/rs/photo/zc303rsphoto")
								}
							}
						}
					}
