		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[RS]렌탈회수사진업로드",
									"targetURL": "#zc303sdphotozc303rsphoto-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zc303sdphotozc303rsphoto-display": {
								"semanticObject": "zc303sdphotozc303rsphoto",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zc303.sd.photo.zc303rsphoto",
									"url": sap.ui.require.toUrl("zc303/sd/photo/zc303rsphoto")
								}
							}
						}
					}
